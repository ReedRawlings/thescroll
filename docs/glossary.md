...
| **Aggro** | An enemy noticing the player and giving chase. Pursuit can cross connected rooms and corridors within a floor; see [exploration](design/exploration.md). |
...
| **Corridor** | A walkable connection between rooms. Enemies can enter and pursue through it. |
...
| **Scene** | A runtime presentation container. It does not define an enemy pursuit boundary. |
